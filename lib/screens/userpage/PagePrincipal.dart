  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: DefaultTabController(
        ...
        child: Column(
          children: [
            avata(image: "assets/images/lezer.jpeg", nom: 'Viera', prenom: 'Marc Oula'),
            // Container(
            //   height: 10,
            // ),
            Container(
                           ...
                           SizedBox(
                            height: 60,
                             child: ListView(
                              ...
                              children: [
                                connectavata(image: 'assets/images/lezer.jpeg',),
                                connectavata(image: 'assets/images/Format.png',),
                                connectavata(image: 'assets/images/ecole.png',),
                                connectavata(image: 'assets/images/image1.png',),
                                connectavata(image: 'assets/images/image2.jpg',),
                                connectavata(image: 'assets/images/lezer.jpeg',),
                              ],
                             ),
                           ),
                          ...
                          children: [
                           ...
                           Card(
                                ...
                                child: ListTile(
                                  ...
                                  radius: 30,
                                  backgroundImage: AssetImage('assets/images/Format.png'),
                                     ),
                                  title: Text('zer oula'),
