...
class _personcompteState extends State<personcompte> {
  ...
  Widget build(BuildContext context) {
                      return GestureDetector(
                        onTap: () {
                               Navigator.push(context, MaterialPageRoute(builder: (context) =>  onzek(title: '',),));
                             },
                        child: Card(
                                  ...
                                  trailing: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child:  Center(
                                          child: Text(widget.numbermes,style: TextStyle(color: Colors.black)
                                          ),
                                        )
                                      ),
                                    ],
 ...
 class connectavata extends StatelessWidget {
     ...
     final String image;
     connectavata({super.key,required  this.image,});
 ...
 enum MenuItem {
  ...
  class avata extends StatelessWidget {
     ...
     final String nom;
     final String prenom;
     avata({super.key,required  this.image,required  this.nom,required  this.prenom,});
            ...
            return Row(
              children:  [
                ...
                PopupMenuButton(
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) =>  para(),));
                        }
                      },
